...
@python_2_unicode_compatible
class AbstractPage(six.with_metaclass(PageBase, MP_Node, index.Indexed, ClusterableModel)):
    ...
    def full_clean(self, *args, **kwargs):
        ...
        super(AbstractPage, self).full_clean(*args, **kwargs)
    ...
    def save(self, *args, **kwargs):
        ...
        result = super(AbstractPage, self).save(*args, **kwargs)
    ...
    def delete(self, *args, **kwargs):
        ...
        if type(self) is Page:
            ...
            return super(AbstractPage, self).delete(*args, **kwargs)
        else:
    ...
    def check(cls, **kwargs):
        errors = super(AbstractPage, cls).check(**kwargs)
    ...
    def get_indexed_objects(cls):
        ...
        return super(AbstractPage, cls).get_indexed_objects().filter(content_type=content_type)
    ...
    def move(self, target, pos=None):
        ...
        super(AbstractPage, self).move(target, pos=pos)
    ...
    def preview_modes(self):
        ...
        """
        return AbstractPage.DEFAULT_PREVIEW_MODES
